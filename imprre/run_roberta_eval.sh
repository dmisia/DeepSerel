...
do python standalone_evaluation.py --model_name_or_path allegro/herbert-large-cased --input_format typed_entity_marker_punct --seed 23 --run_name herbertInq --num_class 9;
